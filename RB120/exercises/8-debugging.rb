...
# #p ellens_postal_service.street_address.to_s
# puts johns_postal_service.send(ellens_postal_service.street_address.to_s, Postcard.new('Greetings from Silicon Valley!'))
# # => undefined method `860 Blackbird Ln.' for #<PostalService:0x00005571b4aaebe8> (NoMethodError)

# Problem 9 - Does it Rock or Not?
